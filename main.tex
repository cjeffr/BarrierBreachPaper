...
\begin{figure}[ht]
    \centering
    \resizebox{\textwidth}{!}{%
            \input{west_central_east_surge.pgf}
        }
...
\begin{figure}[ht]
\centering
    \subfloat[]{\includegraphics[width=0.75\textwidth]{images/output-figure1.pdf}}
    \subfloat[]{\includegraphics[width=0.75\textwidth]{images/output-figure2.pdf}}
     \label{fig3}
...
% outline for discussion....Add full sentences below
\begin{itemize}
