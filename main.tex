...
\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{../../BarrierBreach/visualization/dot_map.pdf}
...
\centering
\resizebox{\textwidth}{!}{%
        \input{../../BarrierBreach/visualization/west_central_east_surge.pgf}
    }
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.75\textwidth]{../../BarrierBreach/visualization/inundation_x_total_breach_area_one_color.png}
    \caption{Total breach area ($km^2$) vs. total inundation change from no breach ($km^2$) for 1500 simulations with the differing randomizations as discussed in the methods}
    \label{fig5}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{../../BarrierBreach/visualization/min_max_mean_inundation.png}
