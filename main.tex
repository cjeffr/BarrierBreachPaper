...
\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{../../BarrierBreachBarrierBreach/visualization/inundation_x_total_breach_area.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{../../BarrierBreach/visualization/fgmax_stats_map_grid.png}
